...
sig = sig[sig$stud == "KieserS_2018.pathabundance_relab.stool",
            c("pathway", "adonis_p", "adonis_FDR", "kruskal_p", "kruskal_FDR")]
rownames(sig) = sig$pathway


## Load pathway abundances
d_path = curatedMetagenomicData("KieserS_2018.pathabundance_relab.stool", dryrun = F)[[1]]
...
d_tax = curatedMetagenomicData("KieserS_2018.metaphlan_bugs_list.stool", dryrun = F)[[1]]
